...
So we plan to publish proceedings for CMNA 26 through [CEUR Workshop Proceedings](http://ceur-ws.org/) as has happened in previous years, but should there be a delay, we'll [pre-publish papers here](/cmna26/programme/) for use during the workshop.
