...
* Download a PDF version of the [first call for papers](/cmna26/assets/cfp/cfp1.pdf)
...
* **[CMT submission link](https://cmt3.research.microsoft.com/CMNA2026)**
...
All accepted submissions will be archived locally on this site. We intend to also submit a volume of long & short papers to be archved as workshop proceedings through CEUR. Demos & posters will only be archived locally.

# Contribution Style 

For final proceedings submission it is mandatory to use the [CEUR styles](https://ceurws.wordpress.com/2020/03/31/ceurws-publishes-ceurart-paper-style/) specifically the single column style from [this page](http://ceur-ws.org/Vol-XXX/). It is also highly recommended that you prepare your submission for initial review using this style to avoid challenges later.
...
We've gotten into the habit recently of publishing pre-proceedings shortly before the workshop so that folk can attend having prepared for the workshop, knowing what to expect, and being ready to engage with the presented work. 

So we intend, time permitting, to publish proceedings for CMNA 26 through [CEUR Workshop Proceedings](http://ceur-ws.org/) as has happened in some previous years, but should there be a delay, we'll [pre-publish papers here](/cmna26/programme/) for use during the workshop.
